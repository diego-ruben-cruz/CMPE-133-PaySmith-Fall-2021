                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1> WEBSITE <br>FOR <span id="js-rotating">PERSONAL, BUSINESS</span></h1>
                            <p class="p-large">Paysmith is one of the easiest and feature packed budget management apps in the market. !</p>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-col">
                        <h4>About PaySmith</h4>
                        <p>We're passionate about creating the best application for personal and business's budget management</p>
                    </div>
                </div> <!-- end of col -->
                <div class="col-md-4">
