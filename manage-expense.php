...
echo "<script>window.location.href='manage-Transactions.php'</script>";
} else {
...
<head>
	...
	<title>PaySmith || Edit Transaction(s)</title>
    ...
    ?>
            ...
            <ul class="nav menu">
                ...
                <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                    ...
                    <ul class="children collapse" id="sub-item-1">
                        <li><a class="" href="add-Transactions.php">
                            <span class="fa fa-arrow-right">&nbsp;</span> Add Transaction
                        </a></li>
                        <li><a class="" href="manage-Transactions.php">
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                    ...
                    <ul class="children collapse" id="sub-item-2">
                        <li><a class="" href="Transactions-datewise-reports.php">
                            <span class="fa fa-arrow-right">&nbsp;</span> Day-to-Day
                        </a></li>
                        <li><a class="" href="Transactions-monthwise-reports.php">
                            <span class="fa fa-arrow-right">&nbsp;</span> Month-to-Month
                        </a></li>
                        <li><a class="" href="Transactions-yearwise-reports.php">
    ...
    echo $msg;
            ...
            <table class="table table-bordered mg-b-0">
              <thead>
                <tr>
                  <th>S.NO</th>
                  <th>Transactions Item</th>
                  <th>Transactions Cost</th>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="manage-Transactions.php?delid=<?php echo $row['id'];?>">Delete</a>
                </tr>
                <?php
$cnt=$cnt+1;
}?>
