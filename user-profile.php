...
if (strlen($_SESSION['id']==0)) {
  ...
  $lname=$_POST['lname'];
     ...
     $query=mysqli_query($conn, "update customers set fname ='$fname', lname='$lname' where id='$userid'");
    if ($query) {
...
<head>
	...
	<title>Pay Smith || User Profile</title>
  ...
  <body>
    ...
    echo $msg;
						...
						<div class="col-md-12">
							 <?php
$userid=$_SESSION['id'];
$ret=mysqli_query($conn,"select * from customers where id='$userid'");
$cnt=1;
...
?>
							<form role="form" method="post" action="">
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php  echo $row['fname'];?>" name="fname" required="true">

								</div>

  								<div class="form-group">
  									<label>Last Name</label>
  									<input class="form-control" type="text" value="<?php  echo $row['lname'];?>" name="lname" required="true">
                    </div>
              	<div class="form-group">
									<label>Email</label>
